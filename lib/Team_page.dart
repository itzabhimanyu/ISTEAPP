...
class _TeamScreenState extends State<TeamScreen> {
  ...
  List<Map<String, String>> executiveMembers = [
    ...
    {
      'name': 'Maramreddy Gayathri Reddy',
      'year': '2025',
      'contact': '7815836068'
    },
    ...
    {
      'name': 'Kakarla Naveen Janaki Ram',
      'year': '2026',
      'contact': '9481543685'
    },
    ...
    {'name': 'Likith M', 'year': '2026', 'contact': '8050518620'},
    {
      'name': 'Ponnolu Sanjeeva Thanmaiee',
      'year': '2026',
      'contact': '9440650167'
    },
    {'name': 'Riya Aji', 'year': '2026', 'contact': '8089590299'},
    ...
    {
      'name': 'Tharlada Durga Tirumala Nischal',
      'year': '2026',
      'contact': '7671024193'
    },
    ...
    {
      'name': 'Vishwajeet Hanamant Dodyalkar',
      'year': '2026',
      'contact': '9322543156'
    },
    ...
    {
      'name': 'Vinitsing mohansing angadi',
      'year': '2027',
      'contact': '6363749411'
    },
    ...
    {
      'name': 'Sai Govardhan Rao Medikurthi',
      'year': '2027',
      'contact': '6301062797'
    },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: widget.isDarkMode ? const Color(0xFF131318) : Colors
          .white,
      appBar: AppBar(
        backgroundColor: widget.isDarkMode ? const Color(0xFF131318) : Colors
            .white,
          ...
          Padding(
            ...
            child: TextField(
              ...
              style: TextStyle(
                  color: widget.isDarkMode ? Colors.white : Colors.black),
              // Text color
              cursorColor: widget.isDarkMode ? Colors.white : Colors.blue,
              // Cursor color
              decoration: InputDecoration(
                ...
                enabledBorder: OutlineInputBorder(
                  borderSide: BorderSide(
                      color: widget.isDarkMode ? Colors.grey : Colors.black45),
                ),
                focusedBorder: OutlineInputBorder(
                  borderSide: BorderSide(
                      color: widget.isDarkMode ? Colors.blue : Colors.blue),
                ),
              ),
            ),
          ),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: widget.isDarkMode ? Colors.blue[800] : Colors
                      .blue[100],
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Padding(
              ...
              // Indent members to show hierarchy
              child: ListTile(
                ...
                subtitle: member['role'] != null
                  ...
                  member['role']!,
                  style: TextStyle(
                    color: widget.isDarkMode ? Colors.grey[400] : Colors
                        .grey[700],
                  ),
                )
                    : null,
...
// Helper function to assign different colors to different teams
  ...
  void showMemberDetails(Map<String, String> member) {
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          backgroundColor: widget.isDarkMode ? const Color(0xFF1E1E1E) : Colors
              .white,
          title: Text(
            member['name']!,
            style: TextStyle(
